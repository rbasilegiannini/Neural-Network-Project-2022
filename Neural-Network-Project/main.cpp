...
/**
		...
		auto duration_chk = duration_cast<microseconds>(stop_chk - start_chk);

		cout << "Test number: " << nTest << ". Number of params: " << sumOfParams << ", time (chk): " << duration_chk.count() << " us. " 
				<< "time (chk):" << duration_bp.count() << " us" << endl;
